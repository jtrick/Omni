-- User Access Tracking for the ACE Omniscience System component.
-- File : 'omni.sql'
-- Database structure for user tracking system.
...
INSERT INTO Site_pri (SiteID, Name, Description) VALUES 
('1', 'Test Site', 'Not a real website, used for testing purposes.');
...
CREATE TABLE "Key_pri" (
	...
	"OldKeyID" integer NOT NULL DEFAULT '0',
...
CREATE TABLE "Hit_pri" (
	...
	"Data" text NOT NULL,
	"Times" text NOT NULL,
	"InitLog" text NOT NULL,
	"PingLog" text NOT NULL,
	"ClientLog" text NOT NULL,
	"ClientTimes" text NOT NULL,
	"ClientWindow" text NOT NULL,
	"Value" float NOT NULL DEFAULT '0',
...
CREATE TABLE "Connection_pri" (
	...
	"LastActionTime" timestamp NOT NULL DEFAULT 0,
	"Duration" timestamp NOT NULL DEFAULT '00:00:00'
);
...
--	Event_typ
--
--	The events and actions available to users. 

CREATE TABLE "Event_typ" (
	"EventTyp" SERIAL PRIMARY KEY,
	"Name" varchar(50) NOT NULL DEFAULT '',
	"Description" text NOT NULL,
...
INSERT INTO Event_typ (EventTyp, Name, Description, Code, Value) VALUES 
('1', 'Hover Wary', 'When a user hovers over an item but does not click on it.', 'hov-wary', '0');
...
CREATE TABLE "Event_log" (
	"LogID" SERIAL PRIMARY KEY,
	"EventTyp" integer NOT NULL DEFAULT '0',
	"ConnectionID" integer NOT NULL DEFAULT '0',
	"HitID" integer NOT NULL DEFAULT '0',
	"PrintID" integer NOT NULL DEFAULT '0',
	"UserID" integer NOT NULL DEFAULT '0',
...
('1', 'Null', 'The DEFAULT method of interaction, html interface via any standards-compliant internet browser.');
